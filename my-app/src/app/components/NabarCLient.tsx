...
export default  function NavbarClient() {
  return (
    <>
      <header className="bg-gradient-to-r from-red-300 via-red-500 to-red-600 text-white shadow-md ">
        <div className="container mx-auto flex items-center justify-between py-4 px-6">
          ...
          <div className="flex items-center w-1/3 relative justify-center">
            <input
              type="text"
